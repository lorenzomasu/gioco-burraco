...
- Tests: Vitest 50 files / 965 tests passed (917 at `a821549`); Playwright Chromium 57/57 passed (56 at `a821549`)
...
- Table (`GameTable.tsx`, new `GuidedCoach.tsx`): with guidance enabled the coach replaces
  ...
  contestuale» with heading and «Nascondi guida»; not a live region, no focus movement, no
